...
Type /donate for donation."""
    DOWNLOAD_START_VIDEO = "🟡 Downloading 🟡"
    DOWNLOAD_START = "🟡 Downloading 🟡"
    UPLOAD_START_VIDEO = "⚪ Uploading ⚪"
    ...
    SAVED_CUSTOM_THUMB_NAIL = "ThumbNail will be deleted with in 24hr"
    DEL_ETED_CUSTOM_THUMB_NAIL = "✅ Custom thumbnail cleared succesfully."
    FF_MPEG_DEL_ETED_CUSTOM_MEDIA = "✅ Media cleared succesfully."
    SAVED_RECVD_DOC_FILE = "🟣 Downloaded 🟣"
    SAVED_RECVD_DOC_FILE_VIDEO = "🟣 Downloaded 🟣"
